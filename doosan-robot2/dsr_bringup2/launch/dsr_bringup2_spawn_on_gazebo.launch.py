...
def generate_launch_description():
    ARGUMENTS =[ 
        ...
        DeclareLaunchArgument('host',  default_value = '110.120.1.39', description = 'ROBOT_IP'       ),
        ...
        DeclareLaunchArgument('rt_host',    default_value = '110.120.1.30',     description = 'ROBOT_RT_IP'    ),
