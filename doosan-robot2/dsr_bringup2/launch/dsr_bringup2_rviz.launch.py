...
def generate_launch_description():
    ARGUMENTS =[ 
        ...
        DeclareLaunchArgument('host',  default_value = '127.0.0.1', description = 'ROBOT_IP'       ), #110.120.1.39
        ...
        DeclareLaunchArgument('rt_host',    default_value = '127.0.0.1',     description = 'ROBOT_RT_IP'    ), #110.120.1.4
